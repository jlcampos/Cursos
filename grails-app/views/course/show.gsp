            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="course.documents.label" default="Documents" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="course.user.label" default="User" /></td>
                            
                            <td valign="top" class="value"><g:link controller="user" action="show" id="${courseInstance?.user?.id}">${courseInstance?.user?.encodeAsHTML()}</g:link></td>
