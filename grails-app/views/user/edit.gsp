                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="uid"><g:message code="user.uid.label" default="Uid" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'uid', 'errors')}">
                                    <g:textField name="uid" value="${fieldValue(bean: userInstance, field: 'uid')}" />
                                </td>
                            </tr>
